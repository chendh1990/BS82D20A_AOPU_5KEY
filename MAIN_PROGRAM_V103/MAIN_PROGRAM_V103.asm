...
message '****************************************************************'
message '*PROJECT NAME :MAIN PROGRAM V103                               *'
message '*     VERSION :V103                                            *'
message '* ICE VERSION :                                                *'
message '*      DATE   :20160302                                        *'
message '*      REMARK :V103 add 33~36 key                              *'
message '****************************************************************'
                ;=INCLUDE REFERENCE FILE
                INCLUDE MAIN_PROGRAM_V103.INC
...
_LOAD_HXT_REFERENCE:
                ...
                if      TouchKeyAmount > 32
                ;-KEY33 THRESHOLD
                MOV     A,Key33Threshold
                MOV     _GLOBE_VARIES[35],A
                endif

                if      TouchKeyAmount > 33
                ;-KEY34 THRESHOLD
                MOV     A,Key34Threshold
                MOV     _GLOBE_VARIES[36],A
                endif

                if      TouchKeyAmount > 34
                ;-KEY35 THRESHOLD
                MOV     A,Key35Threshold
                MOV     _GLOBE_VARIES[37],A
                endif

                if      TouchKeyAmount > 35
                ;-KEY36 THRESHOLD
                MOV     A,Key36Threshold
                MOV     _GLOBE_VARIES[38],A
                endif
